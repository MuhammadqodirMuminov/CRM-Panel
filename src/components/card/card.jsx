			...
			<div className={styles.card__inner}>
				<div className={styles.top}>
					<div className='d-flex'>
						...
						<div>
							<p className={styles.text}>
								{"O'qituvchi"}: <span>{teacher_name}</span>
							</p>
							<p className={styles.text}>
								Tel raqam: <span>{teacher_phone}</span>
							</p>
						</div>
					</div>
					<ul className={styles.card__list}>
						<li>
							<p className={styles.text}>
								Dars kunlari:<span>{course_days}</span>
							</p>
						</li>
						<li>
							<p className={styles.text}>
								Dars vaqti:<span>{course_time}</span>
							</p>
						</li>
						<li>
							<p className={styles.text}>
								O’quvchilar soni<span>{group_members}</span>
							</p>
						</li>
						<li>
							<p className={styles.text}>
								To’lov qilganlar<span>{payments_count}</span>
							</p>
						</li>
					</ul>
				</div>
